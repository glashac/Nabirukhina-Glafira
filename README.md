...
> Соответствует методическим требованиям по дисциплине «Современные технологии программирования» (4 семестр, 09.03.03 «Прикладная информатика»), Финансовый университет.
